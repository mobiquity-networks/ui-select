 ...
 * Version: 0.11.2 - 2015-10-19T14:48:55.232Z
 * License: MIT
 */
...
$templateCache.put("select2/match-multiple.tpl.html","<span class=\"ui-select-match\"><li class=\"ui-select-match-item select2-search-choice\" ng-repeat-start=\"$item in $select.selected | limitTo: $select.showLimit\" ng-class=\"{\'select2-search-choice-focus\':$selectMultiple.activeMatchIndex === $index, \'select2-locked\':$select.isLocked(this, $index)}\" ng-if=\"displayMatchWhen($select, $item)\" ui-select-sort=\"$select.selected\"><span uis-transclude-append=\"\"></span> <a href=\"javascript:;\" class=\"ui-select-match-close select2-search-choice-close\" ng-click=\"$selectMultiple.removeChoice($index)\" tabindex=\"-1\"></a></li><li class=\"ui-select-match-item select2-search-choice\" ng-repeat-end=\"\" ng-if=\"$last && $select.showLimit && $select.selected.length > $select.showLimit\"><ng-include src=\"chickletsDisplayTemplateUrl\" ng-if=\"chickletsDisplayTemplateUrl\"></ng-include><span ng-if=\"!chickletsDisplayTemplateUrl\"><span class=\"ng-binding ng-scope\">{{$select.selected.length}} of {{$select.items.length}}</span></span></li></span>");
